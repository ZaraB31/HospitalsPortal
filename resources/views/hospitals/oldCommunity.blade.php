...
<section class="secondNav">
    <ul>
        <li><a href="/Hospitals/{{$hospital->id}}/Community">Current Test Results</a></li>
        <li style="text-decoration:underline;"><a href="/Hospitals/{{$hospital->id}}/Community/OldTests">Previous Test Results</a></li>
    </ul>
</section>
